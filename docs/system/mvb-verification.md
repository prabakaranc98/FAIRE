...
**Pages scanned:** 19
**MVB stacks checked:** 3 (passed: **2**, failed: **1**)
**External URLs checked:** 171 (trusted: **118**, flagged: **53**)
...
- docs/curriculum/05-statistical-probabilistic-ml/bayesian-nn.md → low-trust (0.00): https://www.microsoft.com/en-us/research/people/cmbishop/prml-book/  (low trust (0.00): no positive signals matched)
...
- docs/curriculum/05-statistical-probabilistic-ml/em.md → low-trust (0.00): https://scikit-learn.org/stable/modules/generated/sklearn.mixture.GaussianMixture.html  (low trust (0.00): no positive signals matched)
- docs/curriculum/05-statistical-probabilistic-ml/em.md → low-trust (0.00): https://pyro.ai/  (low trust (0.00): no positive signals matched)
...
- docs/curriculum/05-statistical-probabilistic-ml/em.md → low-trust (0.00): https://www.microsoft.com/en-us/research/people/cmbishop/prml-book/  (low trust (0.00): no positive signals matched)
...
- docs/curriculum/04-neural-networks-dl/cnn.md → low-trust (0.40): https://pytorch.org/vision/stable/index.html  (low trust (0.40): +0.40 approved-research-domain)
- docs/curriculum/04-neural-networks-dl/cnn.md → low-trust (0.00): https://www.tensorflow.org/guide/keras/custom_layers_and_models  (low trust (0.00): no positive signals matched)
- docs/curriculum/04-neural-networks-dl/cnn.md → low-trust (0.00): https://github.com/pytorch/vision  (low trust (0.00): no positive signals matched)
- docs/curriculum/04-neural-networks-dl/cnn.md → low-trust (0.40): https://pytorch.org/vision/stable/index.html  (low trust (0.40): +0.40 approved-research-domain)
- docs/curriculum/04-neural-networks-dl/cnn.md → low-trust (0.00): https://www.tensorflow.org/guide/keras/custom_layers_and_models  (low trust (0.00): no positive signals matched)
...
- docs/curriculum/08-causal-statistical-inference/disentanglement.md → low-trust (0.00): https://pyro.ai/examples/vae.html  (low trust (0.00): no positive signals matched)
...
- docs/curriculum/15-ml-theory-foundations/bias-variance.md → low-trust (0.00): https://scikit-learn.org/stable/modules/model_selection.html  (low trust (0.00): no positive signals matched)
...
- docs/curriculum/03-representation-learning/bootstrapping-methods.md → low-trust (0.00): https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.BaggingRegressor.html  (low trust (0.00): no positive signals matched)
...
| `docs/curriculum/04-neural-networks-dl/cnn.md` | curriculum | 0 | 0 | 15 | 10 |
